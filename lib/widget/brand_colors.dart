...
const buttonColor = Color(0xFF246BFD);
const secondaryColor = Color(0xFF292B3E);
const bgColor = Color(0xff191A22);
const circlr = Color(0xF8F8F8);

const defaultPadding = 16.0;
const Color aGreyColor = Color(0xff8E8E93);
...
const Color aTextColor = Color(0xFFE4E4E6);
const Color aTextColorDark = Color(0xFF8A8A8E);
